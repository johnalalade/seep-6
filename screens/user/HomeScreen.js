...
const category = [
  {
    _id: "64d7bc3329462e132ddf707c",
    title: "Clothings",
    image: require("../../assets/icons/garments.png"),
  },
  {
    _id: "64d7bbd929462e132ddf7078",
    title: "Electornics",
  ...
  // },
  {
    _id: "64d7bbbe29462e132ddf7076",
    title: "Groceries",
    image: require("../../assets/icons/grocery.png"),
  },
  {
    _id: "64d7bc1329462e132ddf707a",
    title: "Accessories",
    image: require("../../assets/icons/grocery.png"),
  },
];
    ...
    <View style={styles.container}>
      ...
      <View style={styles.topBarContainer}>
        ...
        <View style={styles.topbarlogoContainer}>
          ...
          <Text style={styles.toBarText}>iMarket</Text>
        </View>
        <TouchableOpacity
              ...
              <FlatList
                ...
                renderItem={({ item, index }) => (
                  ...
                  >
                    <ProductCard
                      name={item.title}
                      image={`${item.image}`} // ${network.serverip}/uploads/
                      price={item.price}
